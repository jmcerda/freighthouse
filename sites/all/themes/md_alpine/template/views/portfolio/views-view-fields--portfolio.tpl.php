...
<div class="portfolio-item <?php foreach($row->field_field_po_taxonomy as $key => $value): print 'tid-'.$value['raw']['tid'].' ';endforeach;?>">
    <div class="portfolio">
        ...
        <a href="node/<?php print $row->nid;?>?width=600&height=600" data-nid="<?php print $row->nid;?>" class="zoom colorbox-node"> <?php if(isset($fields['field_po_thumbnail']) && !empty($row->field_field_po_thumbnail)):?><img src="<?php print image_style_url('portfolio_thumbnails',$row->field_field_po_thumbnail[0]['rendered']['#item']['uri']);?>" alt="Freighthouse"/><?php endif;?>
