...
?>
<?php
$social = $row->field_field_location_socials;
...
<div class="col-md-3 col-sm-3 col-md-3 col-xs-12">
    <div class="element-line">
        <div class="item_top">
            <div class="img-rounded location-element zoom">
                <div class="location-inner">
                    <div class="location-detail">
                        <div class="location-content">
                            <h3><strong><?php print $fields['title']->content;?></strong></h3>
                            <p>
                                <?php print $fields['field_location_job']->content;?>
                            </p>
                            <ul>
                                ...
                                ?>
                                    <li>
                                        <a href="<?php print $field_collection_item['field_location_social_link'][0]['#markup'];?>"><i class="<?php print $field_collection_item['field_location_social_icon'][0]['#bundle'].' '.$field_collection_item['field_location_social_icon'][0]['#icon'];?> icon-2x"></i></a>
                                    </li>
                                <?php endforeach;?>
                            </ul>
                        </div>
