                        ...
                        <ul>
                            ...
                            <li class="btn-row">
                                <div class="mybutton small">
                                    <a href="<?php print $fields['field_pc_link']->content;?>" class="colorbox-node"><span data-hover="<?php print $fields['field_pc_button_text_hover']->content;?>"><?php print $fields['field_pc_button_text']->content;?></span></a>
                                </div>
                            </li>
                        </ul>
                <?php if($node->sticky == 1):?>
