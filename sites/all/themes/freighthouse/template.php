...
function freighthouse_form_alter(&$form, &$form_state, $form_id) {
    if (strpos($form_id,"webform_client_form") === false) {
        switch ($form_id) {
            case 'user_login':
              ...
              <div class="col-md-12 text-center">
                  <div class="action mybutton medium"><span style="position:relative; display:inline-block;" data-hover="Login">';
            ...
            case 'user_register_form':
                ...
                $form['actions']['submit']['#prefix'] = '<div class="row">
              <div class="col-md-12 text-center">
                  <div class="action mybutton medium"><span style="position:relative; display:inline-block;" data-hover="Sign up">';
                $form['actions']['submit']['#suffix'] = '</span></div>
              </div>
            </div>';
                break;
        ...
        */   
        ...
        $form['actions']['submit']['#prefix'] = '<div class="row">
              <div class="col-md-12 text-center">
                <div class="action mybutton"><span style="position:relative; display:inline-block;" data-hover="<input class=webform-submit button-primary form-submit type=submit name=op value=Send Message>">';
        $form['actions']['submit']['#sufix'] = '</span></div>
                </div>
              </div>
            ';    
