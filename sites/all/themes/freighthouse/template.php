        ...
        switch ($form_id) {
            case 'user_login':
              ...
              <div class="col-md-12 text-center">
                  <div class="action mybutton medium"><button onclick="this.submit();"><span style="position:relative; display:inline-block; padding:0px;" data-hover="Login">';
            ...
            case 'user_register_form':
                ...
                $form['actions']['submit']['#prefix'] = '<div class="row">
              <div class="col-md-12 text-center">
                  <div class="action mybutton medium"><button onclick="this.submit();"><span style="position:relative; display:inline-block; padding:0px;" data-hover="Sign up">';
                $form['actions']['submit']['#suffix'] = '</span></button></div>
              </div>
            </div>';
                break;
